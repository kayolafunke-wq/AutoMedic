  ...
  useEffect(() => {
    Promise.all([
      ...
      if (techs) setTechPerf((techs.data.data || []).map(t => ({
        name:   t.name,
        jobs:   Number(t.total_jobs   || 0),
        active: Number(t.active_jobs  || 0),
        done:   Number(t.completed_jobs || 0),
      })))
...
function ReceiptModal({ receipt, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-start justify-center pt-8 pb-8 p-4 backdrop-blur-sm overflow-y-auto print:p-0 print:static print:bg-white">
      <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl print:shadow-none print:w-full print:max-w-none print:p-0" onClick={e => e.stopPropagation()}>
        {/* Header */}
